...
abstract class FlutterPaypalNativePlatform extends PlatformInterface {
  ...
  static FlutterPaypalNativePlatform _instance =
  ...
  static FlutterPaypalNativePlatform get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [FlutterPaypalPlatform] when
  /// they register themselves.
  static set instance(FlutterPaypalNativePlatform instance) {
